...
public class fakerClass {
        ...
        public String getFakeEmailID() {
            ...
            System.out.println(companyDomainName);
        ...
        public String getAirportCode() {
            ...
            String[] airportCodes = {"AAR"," ABD"," AEH"," ABZ"," ABR"," ABJ"," ABI"," AUH"," ABV",
            ...
            // #endregion
            int numberOfAirportCodes = airportCodes.length;
            Random r = new Random();
            int randomNumber = r.nextInt(numberOfAirportCodes);
            return airportCodes[randomNumber];
        }
        // #endregion
    
        // #region Get Flight Number - BA576
        public String getFlightNumber() {
            // #region List of all airport codes
            String[] listFlightcodes = {"JP","EI","SU","AR","AM","ZB","AH","PA","BP","2J","TY","SB","AC","TX","UP","CA","EN","UX","AF","IC","VU","MD","KM","MK","9U","SW","NZ",
                   "PX","TL","GZ","HC","HM","JU","YI","TN","TC","8T","TS","NF","ZW","UM","FO","4Z","AS","AZ","NH","AA","M6","ZE","FG","IZ","R7","OZ","RC","RC","IG","5Y",
                   "KK","OS","AV","UP","PG","JV","CH","BG","NT","DB","BA","BS","SN","FB","MO","5T","9K","BW","V3","CX","KX","9M","CI","MU","CZ","DE","CM","SS","OU","CU",
                   "OK","DL","KA","T3","MS","LY","EK","EM","ET","BR","EV","EL","FE","FJ","AY","7F","BE","F9","GA","GB","GF","HU","HA","YO","QX","IB","FI","6E","IR","LN",
                   "JC","JL","EG","NU","JQ","KQ","KL","WA","KE","KU","KU","TM","XL","LP","QV","LI","LO","LH","LG","MH","AE","MP","2M","ME","YV","MX","ME","YM","9K","RA",
                   "EJ","HW","ON","OA","WY","8P","PK","HI","KS","YP","PR","LO","NI","PW","PB","QF","QR","AT","BI","RJ","FR","7H","WB","S7","9R","SV","SK","YR","ZH","SQ",
                   "QS","IE","SA","XO","WN","NK","P8","UL","EZ","SY","XQ","PY","LX","VR","PZ","EQ","TP","RO","T2","TG","BY","9N","TU","TK","PS","UA","US","UJ","VN","VX",
                   "VS","VA","VH","WS","XP","IY" };
            // #endregion
        ...
        public String getSpecialInstructions() {
            Random r = new Random();
            String[] listSpecialInstructions = {"Extra bed","Extra blanket","Free WiFi","Swimming Pool","AC Room" };
            int randomNumber = r.nextInt(listSpecialInstructions.length);
            return listSpecialInstructions[randomNumber];
        }
        // //#endregion
    }